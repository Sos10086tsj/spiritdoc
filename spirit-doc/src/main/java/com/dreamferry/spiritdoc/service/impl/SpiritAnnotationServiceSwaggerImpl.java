 ...
 */
@Service("swaggerSpiritAnnotationService")
@Slf4j
public class SpiritAnnotationServiceSwaggerImpl implements SpiritAnnotationService {
	...
	private ShowDocItem parseAnnotation(String apiPath, String[] requestMethods, Api classAnnotation,
			Method method) {
